...
const Profile = () => {
  ...
  const handleSubmit = () => {
    ...
    toast.promise(
      axios
        .post(
          `${process.env.REACT_APP_API_URL}/api/users/userupdate`,
          { userdata: userUpdate },
          config
        )
        .then((res) => {
    ...
    <div className="my-10 w-full ">
      {user && (
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
          ...
          <div className="">
            <h1 className="text-4xl  mb-5  text-center uppercase">
              User information
            </h1>
            ...
            <div>
              <button
                ...
                className="px-10 py-2 bg-five text-white rounded mx-auto block"
              >
                Update
              </button>
            </div>
